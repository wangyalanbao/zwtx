...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post" enctype="multipart/form-data">
			...
			<tr>
				...
				<td>
					<span class="fieldSet">
						...
						<a href="${base}${setting.logo}" target="_blank">${message("admin.common.view")}</a>
					</span>
				</td>
			</tr>
			<tr>
		...
		<table class="input tabContent">
            ...
            <tr>
                <th>
                    <span class="requiredField">*</span>${message("Setting.consultationImageUploadPath")}:
                </th>
                <td>
                    <input type="text" name="consultationImageUploadPath" class="text" value="${setting.consultationImageUploadPath}" maxlength="200" />
                </td>
            </tr>
		</table>
		<table class="input tabContent">
		...
		<table class="input tabContent">
            ...
            <tr>
                <th>
				${message("Setting.receivedOrder")}:
                </th>
                <td>
                    <input type="text" name="receivedOrder" class="text" value="${setting.receivedOrder}" maxlength="5"
                           onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')" onblur="if(isNaN(value))execCommand('undo')"/>
                </td>
            </tr>
		</table>
		<table class="input">
