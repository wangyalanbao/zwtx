...
<%@page import="com.hxlm.health.web.Setting"%>
<%@page import="com.hxlm.health.web.util.SettingUtils"%>
<%@page import="com.hxlm.health.web.util.SpringUtils"%>
<%@page import="com.hxlm.health.web.Setting.CaptchaType"%>
<%@page import="com.hxlm.health.web.Setting.AccountLockType"%>
<%@page import="com.hxlm.health.web.service.RSAService"%>
	...
	<%if (applicationContext != null) {%>
		<div class="login">
			<form id="loginForm" action="login.jsp" method="post">
				...
				<div class="powered">COPYRIGHT © 2015-2015 ALL RIGHTS RESERVED.</div>
				<div class="link">
