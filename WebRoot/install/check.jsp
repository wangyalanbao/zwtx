...
<%
	...
	boolean isHealthlmXmlCanWrite = isCanWrite(rootPath + "/WEB-INF/classes/healthlm.xml");
	boolean isHealthlmPropertiesWrite = isCanWrite(rootPath + "/WEB-INF/classes/healthlm.properties");
	...
	String isHealthlmXmlCanWriteInfo = null;
	if (isHealthlmXmlCanWrite) {
		isHealthlmXmlCanWriteInfo = "<span class=\"green\">√</span>";
	} else {
		isHealthlmXmlCanWriteInfo = "<span class=\"red\">×</span>";
	}
	String isHealthlmPropertiesInfo = null;
	if (isHealthlmPropertiesWrite) {
		isHealthlmPropertiesInfo = "<span class=\"green\">√</span>";
	} else {
		isHealthlmPropertiesInfo = "<span class=\"red\">×</span>";
	}
...
$().ready( function() {
	...
	<%if ((freeSpace != 0 && freeSpace < 51200) || (maxMemory != 0 && maxMemory < 128) || !isHealthlmXmlCanWrite || !isHealthlmPropertiesWrite || !isWebXmlCanWrite || !isUploadCanWrite) { %>
		hasWarn = true;
	<% } %>
	...
	<div class="body">
		...
		<div class="bodyRight">
			...
			<table>
				...
				<tr>
					<td>
						/WEB-INF/classes/healthlm.xml
					</td>
					<td>
						可写
					</td>
					<td>
						<%=isHealthlmXmlCanWriteInfo%>
					</td>
				</tr>
				<tr>
					<td>
						/WEB-INF/classes/healthlm.properties
					</td>
					<td>
						可写
					</td>
					<td>
						<%=isHealthlmPropertiesInfo%>
					</td>
				</tr>
				<tr>
					<td>
