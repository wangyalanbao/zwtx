			...
			<div class="bodyRight">
				<table>
					...
					<tr>
						<td>数据库用户名:</td>
						<td>
							<input type="text" id="databaseUsername" name="databaseUsername" class="text" maxlength="200"  value="health" />
							<span class="requireField">*</span>
						</td>
					</tr>
					<tr>
						<td>数据库密码:</td>
						<td>
							<input type="password" id="databasePassword" name="databasePassword" class="text" maxlength="200"  value="health"/>
						</td>
					</tr>
					<tr>
						<td>数据库名称:</td>
						<td>
							<input type="text" id="databaseName" name="databaseName" class="text" value="healthlm" maxlength="200" />
							<span class="requireField">*</span>
						</td>
					</tr>
				</table>
				<table>
					...
					<tr>
						<td>密码:</td>
						<td>
							<input type="password" id="adminPassword" name="adminPassword" class="text" value="admin" maxlength="20" />
							<span class="requireField">*</span>
						</td>
					</tr>
					<tr>
						<td>重复密码:</td>
						<td>
							<input type="password" id="reAdminPassword" name="reAdminPassword" class="text"  value="admin" maxlength="20" />
							<span class="requireField">*</span>
						</td>
					</tr>
				</table>
