...
(function($) {
	...
	$.checkLogin = function() {
		var result = false;
		$.ajax({
			url: healthlm.base + "/login/check.jhtml",
			type: "GET",
			dataType: "json",
			cache: false,
			async: false,
	...
	$.redirectLogin = function (redirectUrl, message) {
		var href = healthlm.base + "/login.jhtml";
		if (redirectUrl != null) {
	...
	// 跳转登录
	$.redirectToMobileLogin = function (redirectUrl, message) {
		var href = healthlm.base + "/mobile/logins.jhtml";
		if (redirectUrl != null) {
			href += "?redirectUrl=" + encodeURIComponent(redirectUrl);
		}
		if (message != null) {
