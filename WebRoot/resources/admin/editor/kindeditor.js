...
(function (A, i) {
    ...
    if (!A.KindEditor) {
        ...
        var Da = "4.1.6 (2013-03-24)", q = navigator.userAgent.toLowerCase(),
            o = q.indexOf("msie") > -1 && q.indexOf("opera") == -1, da = q.indexOf("gecko") > -1 && q.indexOf("khtml") == -1, V = q.indexOf("applewebkit") > -1, La = q.indexOf("opera") > -1, bc = q.indexOf("mobile") > -1, cc = /ipad|iphone|ipod/.test(q), N = document.compatMode != "CSS1Compat", z = (q = /(?:msie|firefox|webkit|opera)[\/:\s](\d+)/.exec(q)) ? q[1] : "0", Ca = (new Date).getTime(), P = Math.round, f = {
                DEBUG: !1,
                VERSION: Da,
                IE: o,
                GECKO: da,
        ...
        sa.prototype = {
            lang: function (a) {
                ...
                if (d) {
                    ...
                    height: "",
                    overflow: ""
                }), f(document.body.parentNode).css("overflow", "")), c._scrollPos &&
                ...
                var j = c.toolbar = Ab({
                    src: j, html: l.join(""), noDisableItems: c.noDisableItems, click: function (a, b) {
                        a.stop();
                        if (c.menu) {
                            var d =
                                c.menu.name;
                ...
                }), m = t(g) - j.div.height(), q = c.edit = yb({
                ...
                d ? (f(A).bind("resize", a), j.select("fullscreen"), i.first().css("visibility", "hidden"), i.last().css("visibility", "hidden")) : (da && f(A).bind("scroll", function () {
                    ...
                    moveEl: h, clickEl: i, moveFn: function (a, b, d, e, g, f) {
                        e += f;
                        c.resize(null, e)
                    }
