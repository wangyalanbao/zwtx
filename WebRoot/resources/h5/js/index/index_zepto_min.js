...
var Zepto = function () {
    ...
    var e, t, n, r, i = [], s = i.slice, o = i.filter, u = window.document, a = {}, f = {}, l = u.defaultView.getComputedStyle, c = {
        "column-count": 1,
        columns: 1,
        "font-weight": 1,
        "line-height": 1,
        ...
        "z-index": 1,
        zoom: 1
    }, h = /^\s*<(\w+|!)[^>]*>/, p = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig, d = /^(?:body|html)$/i, v = ["val", "css", "html", "text", "data", "width", "height", "offset"], m = ["after", "prepend", "before", "append"], g = u.createElement("table"), y = u.createElement("tr"), b = {
        ...
        th: y,
        "*": u.createElement("div")
    }, w = /complete|loaded|interactive/, E = /^\.([\w-]+)$/, S = /^#([\w-]*)$/, x = /^[\w-]+$/, T = {}, toString = T.toString, N = {}, C, k, L = u.createElement("div");
    return N.matches = function (e, t) {
        ...
        offset: function (e) {
            if (e)return this.each(function (t) {
                var r = n(this), i = V(this, e, t, r.offset()), s = r.offsetParent().offset(), o = {
                    top: i.top - s.top,
                    left: i.left - s.left
                };
...
window.Zepto = Zepto, "$"in window || (window.$ = Zepto), function (e) {
    ...
    var n = "", r, i, s, o = {
        ...
        O: "o",
        ms: "MS"
    }, u = window.document, a = u.createElement("div"), f = /^((translate|rotate|scale)(X|Y|Z|3d)?|matrix(3d)?|perspective|skew(X|Y)?)$/i, l, c, h, p, d, v, m, g = {};
    ...
    var t = e.zepto, n = t.qsa, r = t.matches, s = e.expr[":"] = {
        visible: function () {
