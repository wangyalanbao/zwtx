...
var Zepto = function () {
    ...
    var E, j, T, C, S, N, O = [], P = O.concat, A = O.filter, L = O.slice, $ = window.document, Z = {}, D = {}, M = {
        "column-count": 1,
        columns: 1,
        "font-weight": 1,
        "line-height": 1,
        ...
        "z-index": 1,
        zoom: 1
    }, k = /^\s*<(\w+|!)[^>]*>/, R = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, F = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, z = /^(?:body|html)$/i, q = /([A-Z])/g, _ = ["val", "css", "html", "text", "data", "width", "height", "offset"], H = ["after", "prepend", "before", "append"], I = $.createElement("table"), B = $.createElement("tr"), V = {
        ...
        th: B,
        "*": $.createElement("div")
    }, U = /complete|loaded|interactive/, X = /^[\w-]*$/, J = {}, W = J.toString, Y = {}, G = $.createElement("div"), K = {
        tabindex: "tabIndex",
        readonly: "readOnly",
        "for": "htmlFor",
        "class": "className",
    ...
    return Y.matches = function (t, e) {
        ...
        var r;
        if (!t)return Y.Z();
        if ("string" == typeof t)if (t = t.trim(), "<" == t[0] && k.test(t))r = Y.fragment(t, RegExp.$1, n), t = null; else {
            if (n !== E)return T(n).find(t);
            r = Y.qsa($, t)
        } else {
            if (e(t))return T($).ready(t);
            if (Y.isZ(t))return t;
            if (Q(t))r = a(t); else if (i(t))r = [t], t = null; else if (k.test(t))r = Y.fragment(t.trim(), RegExp.$1, n), t = null; else {
                if (n !== E)return T(n).find(t);
                r = Y.qsa($, t)
            }
        }
        ...
        attr: function (t, e) {
            ...
            return "string" != typeof t || 1 in arguments ? this.each(function (n) {
                if (1 === this.nodeType)if (i(t))for (j in t)y(this, j, t[j]); else y(this, t, v(this, e, n, this.getAttribute(t)))
        ...
        offset: function (t) {
            ...
            if (!T.contains($.documentElement, this[0]))return {top: 0, left: 0};
        ...
        css: function (e, n) {
            ...
            }); else for (j in e)e[j] || 0 === e[j] ? s += c(j) + ":" + f(j, e[j]) + ";" : this.each(function () {
        ...
        toggleClass: function (t, e) {
            return t ? this.each(function (n) {
                var r = T(this), i = v(this, t, n, x(this));
...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function (t) {
    ...
    var m, g, v = 0, y = window.document, x = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, b = /^(?:text|application)\/javascript/i, w = /^(?:text|application)\/xml/i, E = "application/json", j = "text/html", T = /^\s*$/, C = y.createElement("a");
    C.href = window.location.href, t.active = 0, t.ajaxJSONP = function (e, n) {
        ...
        var x, b = u.accepts[d], w = {}, E = function (t, e) {
            w[t.toLowerCase()] = [t, e]
        }, j = /^([\w-]+:)\/\//.test(u.url) ? RegExp.$1 : window.location.protocol, S = u.xhr(), N = S.setRequestHeader;
        if (p && p.promise(S), u.crossDomain || E("X-Requested-With", "XMLHttpRequest"), E("Accept", b || "*/*"), (b = u.mimeType || b) && (b.indexOf(",") > -1 && (b = b.split(",", 2)[0]), S.overrideMimeType && S.overrideMimeType(b)), (u.contentType || u.contentType !== !1 && u.data && "GET" != u.type.toUpperCase()) && E("Content-Type", u.contentType || "application/x-www-form-urlencoded"), u.headers)for (g in u.headers)E(g, u.headers[g]);
    ...
    }, g = {}, v = {}, y = "onfocusin"in window, x = {focus: "focusin", blur: "focusout"}, b = {
    ...
    t.each(m, function (t, n) {
        ...
        var x, b, w, E = {}, j = "", T = this, C = t.fx.transitionEnd, S = !1;
        if (i === e && (i = t.fx.speeds._default / 1e3), g === e && (g = 0), t.fx.off && (i = 0), "string" == typeof r)E[l] = r, E[f] = i + "s", E[p] = g + "s", E[h] = d || "linear", C = t.fx.animationEnd; else {
            b = [];
    ...
    var i = window.document, o = (i.documentElement, t.fn.show), s = t.fn.hide, a = t.fn.toggle;
