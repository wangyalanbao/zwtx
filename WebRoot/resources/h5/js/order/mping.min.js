...
!function (b) {
    ...
    function e() {
        d.call(this, "PV", null), this.type = k.Type.PV, this.setTs("page_ts"), this.setPageParam(), this.setSourceParam()
    }

    function f(a) {
        d.call(this, "Click", null), this.type = k.Type.CLICK, this.event_id = a, this.setTs("click_ts"), this.setPageParam()
    }
    ...
    var k = {
        ...
        Method: {bpReport: "bp.report", bpSearch: "bp.search"},
        Client: {
        ...
        Type: {PV: "1", PERFORMANCE: "2", CLICK: "3", ORDER: "4"},
        Storage: {current: "mba_cur_series", cached: "mba_cached_series"},
        MCookie: {sessionCookieTimeout: 18e5, visitorCookieTimeout: 15552e6}
    }, l = {
        common: {
            report_ts: "",
            method: "",
    ...
    c.prototype = {
        _init: function () {
            ...
            var a = c.tools.Tools, d = c.tools.md5, e = k.Client, f = l.common, g = navigator.userAgent;
            ...
            } else f.client = g.indexOf(e.MICRO_M.UAname) > -1 ? e.MICRO_M.value : e.MM.value, f.device = this._getOs();
            ...
            var b = c.tools.Tools, d = ["word", "wd", "text", "p", "keyword", "q"], e = [];
            if (a.indexOf("?") > -1) {
            ...
            var b = c.tools.Tools, d = {data: []};
            if (b.extend(d, l.common), b.extend(d, this.options), a instanceof c.Request) {
                var e = a.getReportObj();
                e.pinid = this.options.pinid, e.uid = this.options.uid, e.mba_seq = this.privates.mba_seq, b.isEmbedded() && (e.pv_sid = this.privates.pv_sid, e.pv_seq = this.privates.pv_seq), d.data.push(e)
            }
            return d
        }, isSpider: function () {
        ...
        mba_sid: "",
        pin_sid: ""
    }, c.prototype.privates = {mba_seq: "", pv_sid: "", pv_seq: ""}, c.prototype.ready = function () {
    }, c.Request = d, d.prototype.getReportObj = function () {
        var a = {};
        ...
        var a = b.location.search, d = c.tools.Tools, e = ["utm_source", "utm_medium", "utm_term", "utm_campaign"], f = new RegExp(".*(" + e.join("|") + ")=.*");
        ...
        if (!f.attachedEvent) {
            a || (a = "J_ping");
            var d = "touchstart"in b ? "touchstart" : "click", e = document.querySelector("body"), g = c.tools.Tools;
            e.addEventListener(d, function (d) {
                ...
                if (f) {
                    var i = g.attr(f, "href"), j = (function () {
                        return function () {
                            i && /http:\/\/.*?/.exec(i) && "_blank" !== g.attr(f, "target") && (b.location.href = i)
                        }
                    }(), f.getAttribute("report-eventid") ? f.getAttribute("report-eventid") : ""), k = f.getAttribute("report-pagename") ? f.getAttribute("report-pagename") : "", l = f.getAttribute("report-pageparam") ? f.getAttribute("report-pageparam") : "", m = new c.inputs.Click(j), n = new c;
        ...
        if (a) {
            var b = new i(a), d = new c;
            d.send(b)
        }
    }, h.prototype = new f, h.prototype.deleteSeries = function (a) {
        var b = c.tools.Tools;
        if (b.isArray(a))for (var d = 0, e = a.length; e > d; d++)c.EventSeries.deleteSeries(a[d]); else c.EventSeries.deleteSeries(a)
    ...
    var m = {
        eventSeries: {}, getSeries: function () {
            var a = c.tools.Tools, b = new o, d = b.getSidSeq(), e = {
                m_source: a.isEmbedded() ? "1" : "0",
                event_series: this.eventSeries,
                jda: a.getCookie("__jda")
            };
            return a.isEmbedded() ? (e.pv_sid = d[0] + "", e.pv_seq = d[1] + "", e.pv_timestamp = (new Date).getTime() + "") : (e.mba_muid = b.getMuid(), e.mba_sid = d[0] + ""), JSON.stringify(e)
            ...
            if (c.tools.Tools.isEmbedded()) {
                var b = a.event_id, d = b && c.events && c.events.map[b];
            ...
            var b, c, d, e = this.getCookiePart("mba_cur_com"), f = this.getCookiePart("mba_cur_e"), g = {};
            ...
            var b, c, d, e = this.getCookiePart("mba_cur_com"), f = {};
            if (e) {
        ...
        }, subCookieParts: {}, getCookiePart: function () {
            try {
                var b = "mba_event_series=", c = document.cookie.indexOf(b), d = null, e = "";
                if (!(c > -1))return null;
            ...
            var a = "mba_event_series=", b = document.cookie.indexOf(a), c = null, d = {};
            if (b > -1) {
    ...
    c.EventSeries = m, j.prototype = {
        getCurTime: function () {
            ...
            for (var b = (a + "").replace(/(&amp;|\?)/g, "&").split("&"), c = {}, d = 0, e = b.length; e > d; d++) {
                var f = b[d].indexOf("=");
                -1 != f && (c[b[d].substr(0, f).replace(/[^a-zA-Z0-9_]/g, "")] = decodeURIComponent(b[d].substr(f + 1)))
            }
            return c
    ...
    var n = new j, o = function () {
        ...
        return this.getMuid = function () {
            ...
            a[0] = n.getCookie("mba_muid") ? n.getCookie("mba_muid").split(".")[0] : n.getUniq(), this.setMuidCookie()
            ...
            var d, e, f, g = navigator.userAgent, h = g.indexOf("pv/");
            if (h > -1) {
                var i = g.indexOf(";", h);
                0 > i && (i = g.length), d = g.substring(h + 3, i)
            } else d = "1.0";
            if (n.getCookie("mba_sid"))e = n.getCookie("mba_sid"); else {
                var j = n.getCookie("mba_muid"), l = j.split(".");
                if (3 == l.length) {
                    var m = l[1], o = parseInt(l[2]);
    ...
    !function () {
        n.isMobile() && new o
    }(), c.tools || (c.tools = {}), c.tools.Tools = n, b.MPing = c
}(window), function () {
    var a = {
        MHome_FocusPic: 1,
    ...
    MPing.events = {}, MPing.events.map = a
}(window), function () {
    function a(a) {
        return c(b(d(a)))
    }
    ...
    var o = 0;
    MPing.tools || (MPing.tools = {}), MPing.tools.md5 = {hex_md5: a}
}(window);