(function () {
    MCommonHeaderBottom = function (d) {
        ...
        var e = {useDefaultImp: true, css: ["http://st.360buyimg.com/common/commonH_B/css/header.css?v=" + a], js: []};
        if (d) {
        ...
        var c = {
            _isIncludedCss: false, debug: false, getSid: function (i, j) {
                if (this._isNotBlank(j)) {
                    return i + "sid=" + j
                }
                return ""
            }, getParam: function (k, i, j) {
                ...
                var l = i.prefix;
                var j = i.divId;
                var m = this.templeteOutput({templete: n, param: {prefix: l, sid: k}});
        ...
        var h = {
            ...
            create: function (k) {
                ...
                c.innerHtml({divId: i, sid: j, htmlStr: n, prefix: m});
        ...
        var b = {
            args: {bottomId: "m_common_bottom", sid: "", isShowBottom: true, footerPlatforms: ""},
            create: function (k) {
                this.args = k;
                if (!this._validate()) {
                    return false
                ...
                c.innerHtml({divId: i, htmlStr: n, prefix: m});
                var l = this;
            ...
            _getLinksHtml: function (m) {
                var j = "";
                if (m.pin && m.pin != "") {
                    j = '        <li class=""><a class="J_ping" report-eventid="MCommonHTail_Account"  report-eventparam="" page_name="' + f + '" rel="nofollow"  href="http://home.m.jd.com/myJd/home.action{sid}">{pin}</a></li>        <li><a class="J_ping" report-eventid="MCommonHTail_Exit"  report-eventparam="" page_name="' + f + '" rel="nofollow" href="https://passport.m.jd.com/user/logout.action{sid}">退出</a></li>'
                } else {
                    j = '        <li class=""><a class="J_ping" report-eventid="MCommonHTail_Login"  report-eventparam="" page_name="' + f + '" rel="nofollow" href="https://passport.m.jd.com/user/login.action{sid}{returnurl}">登录</a></li>        <li><a class="J_ping" report-eventid="MCommonHTail_Register"  report-eventparam="" page_name="' + f + '" rel="nofollow"  href="http://passport.m.jd.com/register/mobileRegister.action{sid}">注册</a></li>'
                }
                var n = '	<div class="jd-1px-line-up"></div>    <ul class="jd-footer-links">' + j + '        <li><a class="J_ping" report-eventid="MCommonHTail_Feedback"  report-eventparam="" page_name="' + f + '" rel="nofollow" href="http://m.jd.com/showvote.html{sid}">反馈</a></li>        <li><a class="J_ping" report-eventid="MCommonHTail_ToTop"  report-eventparam="" page_name="' + f + '" rel="nofollow" href="#top">回到顶部</a></li>    </ul>';
                var i = c.getSid("?", m.sid);
                var l = m.pin;
                var k = c.getParam(i, "returnurl", m.returnurl);
                n = c.templeteOutput({templete: n, param: {sid: i, pin: l, returnurl: k}});
                return n
            },
            ...
            _addFooterPlatformEvent: function () {
                ...
                i(k, "touchscreen");
                i(k, "apps");
                downloadAppPlugInForBottom(k + "_apps", j.args.downloadAppPlugIn)
            },
        ...
        var g = {
            args: {
                tipId: "m_common_tip", sid: "", isShowTip: true, isfloat: true, onClickTrynow: function () {
                }
            }, create: function (k) {
                this.args = k;
                if (!this._validate()) {
                ...
                c.innerHtml({divId: i, sid: j, htmlStr: o, prefix: n});
                ...
                if (!this.args.isUseCustomDownloadApp) {
                    downloadAppPlugInForFloat(n + "_trynow", n + "_jd_download_tip_x", n + "_jd_download_tip", m.args.downloadAppPlugIn)
                }
            ...
            header: function (i) {
                ...
                return {
                    enum0: [], enum1: [{
                        ...
                        id: 3, name: "pc", href: "", onClickX: function () {
                            skip(k)
                        }
                    }], enum2_2: [{
                        id: 4, name: "apps", href: "", onClickX: function () {
