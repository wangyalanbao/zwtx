...
public class Setting implements Serializable {
	...
	/*图文资讯图片上传路径*/
	private String consultationImageUploadPath;
	/** Flash上传路径 */
	...
	@NotEmpty
	@Length(max = 200)
	public String getConsultationImageUploadPath() {
		return consultationImageUploadPath;
	}

	public void setConsultationImageUploadPath(String consultationImageUploadPath) {
		if(consultationImageUploadPath!=null){
			if(!consultationImageUploadPath.startsWith("/")){
				consultationImageUploadPath="/"+consultationImageUploadPath;
			}
			if(!consultationImageUploadPath.endsWith("/")){
				consultationImageUploadPath +="/";
			}
		}

		this.consultationImageUploadPath = consultationImageUploadPath;
	}
	...
	public void setpOffset(Float pOffset) {
