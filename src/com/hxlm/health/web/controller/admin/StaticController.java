...
//	@Resource(name = "subjectReportServiceImpl")
...
//			List<Article> articles = articleService.findList(articleCategories, beginDate, endDate, first, count);
...
//				isCompleted = false;
//			}
//		}  else if (buildType == BuildType.note) {
//			ArticleCategory articleCategory = articleCategoryService.find(articleCategoryId);
//			List<ArticleCategory> articleCategories = new ArrayList<ArticleCategory>();
//			articleCategories.add(articleCategory);
//			List<Article> articles = articleService.findList(articleCategories, beginDate, endDate, first, count);
//			for (Article article : articles) {
//				buildCount += staticService.buildnote(article);
//			}
//			first += articles.size();
//			if (articles.size() == count) {
//				isCompleted = false;
...
//				isCompleted = false;
//			}
//		} else if (buildType == BuildType.report) {
//			List<SubjectReport> subjectReports = subjectReportService.findList(beginDate, endDate);
//			for (SubjectReport subjectReport : subjectReports) {
//				buildCount += staticService.build(subjectReport);
//			}
//			first += subjectReports.size();
//			if (subjectReports.size() == count) {
//				isCompleted = false;
//			}
