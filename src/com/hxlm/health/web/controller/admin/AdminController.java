...
import com.hxlm.health.web.service.RoleService;
...
public class AdminController extends BaseController {
	...
	public String save(Admin admin, Long[] roleIds,Long companyId, RedirectAttributes redirectAttributes) {
		admin.setRoles(new HashSet<Role>(roleService.findList(roleIds)));
		admin.setCompany(companyService.find(companyId));
	...
	public String update(Admin admin, Long[] roleIds,Long companyId, RedirectAttributes redirectAttributes) {
		admin.setRoles(new HashSet<Role>(roleService.findList(roleIds)));
		admin.setCompany(companyService.find(companyId));
		if (!isValid(admin)) {
			return ERROR_VIEW;
		...
		adminService.update(admin, "username", "loginDate", "loginIp", "orders" ,"userConsultations");
		addFlashMessage(redirectAttributes, SUCCESS_MESSAGE);
		return "redirect:list.jhtml";
	}
