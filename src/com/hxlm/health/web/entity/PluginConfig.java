 ...
 */
@Entity
@Table(name = "lm_plugin_config")
@SequenceGenerator(name = "sequenceGenerator", sequenceName = "lm_plugin_config_sequence")
public class PluginConfig extends OrderEntity {
	...
	@CollectionTable(name = "lm_plugin_config_attribute")
