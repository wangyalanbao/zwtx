 ...
 */
@Embeddable
public class AirplaneImage implements Serializable, Comparable<AirplaneImage> {
	 ...
	 * @return 比较结果
	 */
	public int compareTo(AirplaneImage airplaneImage) {
		return new CompareToBuilder().append(getOrder(), airplaneImage.getOrder()).toComparison();
	}
