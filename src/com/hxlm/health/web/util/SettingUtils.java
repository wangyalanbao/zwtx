...
import com.hxlm.health.web.EnumConverter;
...
public final class SettingUtils {
	...
	public static Setting get() {
		...
		if (cacheElement != null) {
			...
			try {
				...
				Document document = new SAXReader().read(healthlmXmlFile);/** 读取healthlm.xml文件到document对象中*/
				List<Element> elements = document.selectNodes("/healthlm/setting");//返回符合表达式的一个节点LIST
	...
	public static void set(Setting setting) {
		try {
			...
			List<Element> elements = document.selectNodes("/healthlm/setting");
			for (Element element : elements) {
				try {
					String name = element.attributeValue("name");
