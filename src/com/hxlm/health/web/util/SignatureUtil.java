...
import com.hxlm.health.web.plugin.weixinPay.bean.*;
...
public class SignatureUtil {
    ...
    public static String generateSign(Map<String, String> map,String paternerKey){
        ...
        String signStr = DigestUtils.md5Hex(str + "&key=" + paternerKey).toUpperCase();
        System.out.println(" ------------------------------- weixin generateSign ---------------------------------- "+signStr);
        return signStr;
    }
