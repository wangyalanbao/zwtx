...
public class BaseServiceImpl<T, ID extends Serializable> implements BaseService<T, ID> {
	...
	@Transactional
	public void save(T entity) { baseDao.persist(entity); }

	@Transactional
	public T saveAndGet(T entity) {return baseDao.saveAndGet(entity);}

	@Transactional
	public T saveAndReturn(T entity) {return baseDao.saveAndReturn(entity);}
