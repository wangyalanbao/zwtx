...
public interface ProductCategoryService extends BaseService<ProductCategory, Long> {
	 ...
	 * @return
	 */
	ProductCategory findRoot(Product product,Cart cart);
	...
	Long saveProductCategory(ProductCategory productCategory);

	List<ProductCategory>  findListByName(String name);
