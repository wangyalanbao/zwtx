...
public class SnDaoImpl implements SnDao, InitializingBean {
	...
	private HiloOptimizer quoteHiloOptimizer;
	...
	@Value("${sn.quote.prefix}")
	private String quotePrefix;
	@Value("${sn.quote.maxLo}")
	private int quoteMaxLo;
	...
	public void afterPropertiesSet() throws Exception {
		...
		quoteHiloOptimizer = new HiloOptimizer(Type.quote, quotePrefix, quoteMaxLo);
	}
	...
	public String generate(Type type) {
		...
		if (type == Type.product) {
			...
			return quoteHiloOptimizer.generate();
		}
		return null;
	}
