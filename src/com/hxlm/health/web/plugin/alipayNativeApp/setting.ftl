...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		<table class="input">
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.alipayNativeAppPlugin.partner")}:
				</th>
				<td>
            ...
            <tr>
                <th>
                    <span class="requiredField">*</span>${message("admin.plugin.alipayNativeAppPlugin.pubkey")}:
                </th>
                <td>
                    <input type="text" name="pubkey" class="text" value="${pluginConfig.attributes.get("pubkey")}" maxlength="200" />
                </td>
            </tr>
			<tr>
				<th>
