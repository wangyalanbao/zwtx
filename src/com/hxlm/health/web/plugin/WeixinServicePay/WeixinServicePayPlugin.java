...
@Component("weixinServicePayPlugin")
public class WeixinServicePayPlugin extends PaymentPlugin {

    //服务号的应用号
    public static final String APPID = "wx3fdd24c7ecea69d9";
    //服务号的应用密码
    public final static String APP_SECRECT = "f9f392cc8f0f9cc9bab3aee264f9432c";
    public static final String MCH_ID = "1224644602";
    public static final String API_KEY = "KY3H123456789ky3h123456987654321";
    ...
    public String getInstallUrl() {
        return "weixin_service_pay/install.jhtml";
    }

    @Override
    public String getUninstallUrl() {
        return "weixin_service_pay/uninstall.jhtml";
    }

    @Override
    public String getSettingUrl() {
        return "weixin_service_pay/setting.jhtml";
    }
