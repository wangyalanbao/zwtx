package com.hxlm.health.web.plugin.WeixinServicePay;
...
/**
 * Created by dengyang on 15/9/15.
 */

@Controller("adminWeixinServicePayController")
@RequestMapping("/admin/payment_plugin/weixin_service_pay")
public class WeixinServicePayController extends BaseController {

    @Resource(name = "weixinServicePayPlugin")
    private WeixinServicePayPlugin weixinServicePayPlugin;
    ...
    public @ResponseBody
    Message install() {
        if (!weixinServicePayPlugin.getIsInstalled()) {
            PluginConfig pluginConfig = new PluginConfig();
            pluginConfig.setPluginId(weixinServicePayPlugin.getId());
    ...
    Message uninstall() {
        if (weixinServicePayPlugin.getIsInstalled()) {
            PluginConfig pluginConfig = weixinServicePayPlugin.getPluginConfig();
    ...
    public String setting(ModelMap model) {
        ...
        return "/com/hxlm/health/web/plugin/WeixinServicePay/setting";
    }
