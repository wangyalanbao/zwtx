...
@Component("weixinPayWybsPlugin")
public class WeixinPayWybsPlugin extends PaymentPlugin {

    //服务号的应用号
    public static final String APPID = "wx690147712c2a80af";
    //服务号的应用密码
    public final static String APP_SECRECT = "e0acdd5c23eeb2477605ccecc3f3fd27";
    public static final String MCH_ID = "1275047101";
    public static final String API_KEY = "KY3HYANHUANGDONGFANGBBBBBBBBBBBB";
    ...
    public String getInstallUrl() {
        return "weixin_pay_wybs/install.jhtml";
    }

    @Override
    public String getUninstallUrl() {
        return "weixin_pay_wybs/uninstall.jhtml";
    }

    @Override
    public String getSettingUrl() {
        return "weixin_pay_wybs/setting.jhtml";
    }
