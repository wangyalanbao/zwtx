...
<head>
    ...
    <title>${message("admin.plugin.wxpay.setting")}</title>
...
<body>
<div class="path">
    <a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.plugin.wxpay.setting")}
</div>
<form id="inputForm" action="update.jhtml" method="post">
    <table class="input">
        <tr>
            <th>
                <span class="requiredField">*</span>${message("RefundPlugin.refundname")}:
            </th>
            <td>
                <input type="text" name="refundsName" class="text" value="${pluginConfig.attributes['refundsName']}" maxlength="200" />
            </td>
        </tr>
        <tr>
            <th>
                <span class="requiredField">*</span>${message("admin.plugin.wxpay.AppID")}:
            </th>
            <td>
        ...
        <tr>
            <th>
                <span class="requiredField">*</span>${message("admin.plugin.wxpay.AppSecret")}:
            </th>
            <td>
        ...
        <tr>
            <th>
                <span class="requiredField">*</span>${message("admin.plugin.wxpay.PaySecret")}:
            </th>
            <td>
                <input type="text" name="apikey" class="text" value="${pluginConfig.attributes.get("apikey")}" maxlength="200" />
            </td>
        </tr>
        <tr>
            <th>
                <span class="requiredField">*</span>${message("admin.plugin.wxpay.MchId")}:
            </th>
            <td>
                <input type="text" name="mchid" class="text" value="${pluginConfig.attributes.get("mchid")}" maxlength="200" />
            </td>
        </tr>
        <tr>
            <th>
