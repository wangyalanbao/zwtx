 ...
 * 
 */
package com.hxlm.health.web.plugin.paypal;
...
import com.hxlm.health.web.plugin.paypal.PaypalPlugin.Currency;
...
public class PaypalController extends BaseController {
	...
	public String setting(ModelMap model) {
		...
		return "/com/hxlm/health/web/plugin/paypal/setting";
	}
